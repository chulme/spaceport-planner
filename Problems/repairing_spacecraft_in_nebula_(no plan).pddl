(define (problem problem1)
  (:domain space)
     ...
     planetaryScan1 planetaryScan2 - planetaryScan
    ...
    (:goal
        (and    
            (not(spacecraftDamaged)) ;this plan is impossible, since the spacecraft cannot move when damaged and ...
                                     ;MAVs are disabled when launched into a nebula, so cannot repair the ship.
        )
    )
)
